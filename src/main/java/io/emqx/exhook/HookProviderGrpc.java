...
public final class HookProviderGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.emqx.exhook.ClientAuthorizeRequest,
      io.emqx.exhook.ValuedResponse> getOnClientAuthorizeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "OnClientAuthorize",
      requestType = io.emqx.exhook.ClientAuthorizeRequest.class,
      responseType = io.emqx.exhook.ValuedResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.emqx.exhook.ClientAuthorizeRequest,
      io.emqx.exhook.ValuedResponse> getOnClientAuthorizeMethod() {
    io.grpc.MethodDescriptor<io.emqx.exhook.ClientAuthorizeRequest, io.emqx.exhook.ValuedResponse> getOnClientAuthorizeMethod;
      ...
      synchronized (HookProviderGrpc.class) {
        if ((getOnClientAuthorizeMethod = HookProviderGrpc.getOnClientAuthorizeMethod) == null) {
          HookProviderGrpc.getOnClientAuthorizeMethod = getOnClientAuthorizeMethod =
              io.grpc.MethodDescriptor.<io.emqx.exhook.ClientAuthorizeRequest, io.emqx.exhook.ValuedResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "OnClientAuthorize"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.emqx.exhook.ClientAuthorizeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.emqx.exhook.ValuedResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.emqx.exhook.SessionTakenoverRequest,
      io.emqx.exhook.EmptySuccess> getOnSessionTakenoverMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "OnSessionTakenover",
      requestType = io.emqx.exhook.SessionTakenoverRequest.class,
      responseType = io.emqx.exhook.EmptySuccess.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.emqx.exhook.SessionTakenoverRequest,
      io.emqx.exhook.EmptySuccess> getOnSessionTakenoverMethod() {
    io.grpc.MethodDescriptor<io.emqx.exhook.SessionTakenoverRequest, io.emqx.exhook.EmptySuccess> getOnSessionTakenoverMethod;
      ...
      synchronized (HookProviderGrpc.class) {
        if ((getOnSessionTakenoverMethod = HookProviderGrpc.getOnSessionTakenoverMethod) == null) {
          HookProviderGrpc.getOnSessionTakenoverMethod = getOnSessionTakenoverMethod =
              io.grpc.MethodDescriptor.<io.emqx.exhook.SessionTakenoverRequest, io.emqx.exhook.EmptySuccess>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "OnSessionTakenover"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.emqx.exhook.SessionTakenoverRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.emqx.exhook.EmptySuccess.getDefaultInstance()))
  ...
  public static abstract class HookProviderImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void onClientAuthorize(io.emqx.exhook.ClientAuthorizeRequest request,
        io.grpc.stub.StreamObserver<io.emqx.exhook.ValuedResponse> responseObserver) {
    ...
    /**
     */
    public void onSessionTakenover(io.emqx.exhook.SessionTakenoverRequest request,
        io.grpc.stub.StreamObserver<io.emqx.exhook.EmptySuccess> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.emqx.exhook.ClientAuthorizeRequest,
                io.emqx.exhook.ValuedResponse>(
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.emqx.exhook.SessionTakenoverRequest,
                io.emqx.exhook.EmptySuccess>(
  ...
  public static final class HookProviderBlockingStub extends io.grpc.stub.AbstractBlockingStub<HookProviderBlockingStub> {
    ...
    /**
     */
    public io.emqx.exhook.ValuedResponse onClientAuthorize(io.emqx.exhook.ClientAuthorizeRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public io.emqx.exhook.EmptySuccess onSessionTakenover(io.emqx.exhook.SessionTakenoverRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class HookProviderFutureStub extends io.grpc.stub.AbstractFutureStub<HookProviderFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.emqx.exhook.ValuedResponse> onClientAuthorize(
        io.emqx.exhook.ClientAuthorizeRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.emqx.exhook.EmptySuccess> onSessionTakenover(
        io.emqx.exhook.SessionTakenoverRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_ON_CLIENT_AUTHORIZE:
          serviceImpl.onClientAuthorize((io.emqx.exhook.ClientAuthorizeRequest) request,
              (io.grpc.stub.StreamObserver<io.emqx.exhook.ValuedResponse>) responseObserver);
          break;
        ...
        case METHODID_ON_SESSION_TAKENOVER:
          serviceImpl.onSessionTakenover((io.emqx.exhook.SessionTakenoverRequest) request,
              (io.grpc.stub.StreamObserver<io.emqx.exhook.EmptySuccess>) responseObserver);
          break;
